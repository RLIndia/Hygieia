(function () {
	...
	.controller('jiraReleaseViewController',jiraReleaseViewController);

	jiraReleaseViewController.$inject = ['$scope', 'DashStatus', 'projectData', 'DisplayState', '$q', '$modal'];
	function jiraReleaseViewController($scope, DashStatus, projectData, DisplayState, $q, $modal) {
